...
| H-AUD-007 | Low | Drift-Risiko | The default A/B mock mode is biased and its own help text says it can measure structural bias rather than brief effectiveness. | [scripts/ab_harness.py](../scripts/ab_harness.py), [Makefile](../Makefile) | Fixed 2026-04-30: repo-level `make ab-harness` now runs neutral mock mode, reports carry mock-mode provenance, and HARNESS008 prevents regression. |
