...
Current public evidence: 15 real-world repositories in the study corpus, 14 scoring signals (all active since v0.7.0, auto-calibrated at runtime). The [benchmark study](study.md) documents a v0.5 baseline with 6 core signals; quantitative claims there apply to that historical model.
