...
3. **Drift modeling level:** drift currently models 22 signal families, with 14 scoring-active and 8 in report-only mode pending validation; this covers a subset of cross-file erosion patterns with strong reproducibility.
