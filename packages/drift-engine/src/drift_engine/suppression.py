...
from drift_sdk.models import FileInfo, Finding, FindingStatus, SignalType
...
def collect_inline_suppressions(
    ...
    from drift_config import SIGNAL_ABBREV
...
def insert_suppression_comment(
    ...
    *,
    ...
    if signals:
        ...
        abbrevs = sorted(signal_to_abbrev.get(s, s.upper()) for s in signals)
