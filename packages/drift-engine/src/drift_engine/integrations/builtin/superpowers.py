...
from drift_engine.integrations.base import IntegrationContext, IntegrationResult
...
class SuperpowersAdapter:
    ...
    def run(self, ctx: IntegrationContext) -> IntegrationResult:
        from drift_engine.integrations.runner import parse_json_output, run_command
