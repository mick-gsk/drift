...
from drift_engine.response_shaping import build_drift_score_scope

__version__ = _get_version("drift-analyzer")

# Keep the logger name as "drift.baseline" for backward-compat with log consumers and tests.
logger = logging.getLogger("drift.baseline")
