...
if TYPE_CHECKING:
    from drift_engine.patch_writer._base import PatchWriter
...
def _build_registry() -> dict[str, PatchWriter]:
    from drift_engine.fix_intent import EDIT_KIND_ADD_DOCSTRING, EDIT_KIND_ADD_GUARD_CLAUSE
    from drift_engine.patch_writer._add_docstring import AddDocstringWriter
    from drift_engine.patch_writer._add_guard_clause import AddGuardClauseWriter
