...
from drift_engine.fix_intent import EDIT_KIND_ADD_GUARD_CLAUSE
from drift_engine.patch_writer._base import PatchResult, PatchResultStatus, PatchWriter
from drift_engine.patch_writer.shared import _require_libcst
