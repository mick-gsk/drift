...
"""Compat stub: delegates to drift_engine.ingestion (ADR-102 Phase C)."""
...
import drift_engine.ingestion as _target

# Redirect __path__ so submodule imports resolve to drift_engine.ingestion.X
...
from drift_engine.ingestion import *
