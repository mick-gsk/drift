...
if TYPE_CHECKING:
    ...
    from drift.preflight import PreflightResult  # forward ref: lives in drift-engine
    ...
    from drift_sdk.models._enums import PatternCategory
    from drift_sdk.models._git import Attribution, CommitInfo, FileHistory
    from drift_sdk.models._parse import PatternInstance
...
class RepoAnalysis:
    ...
    def grade(self) -> tuple[str, str]:
        ...
        from drift.scoring.engine import score_to_grade  # forward ref: lives in drift-engine
