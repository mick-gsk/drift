...
if TYPE_CHECKING:
    from drift_sdk.models._patch import PatchIntent

from drift_sdk.models._context import NegativeContext
...
class AgentTask:
    ...
    def to_patch_intent(self, session_id: str | None = None) -> PatchIntent:
        ...
        from drift_sdk.models._patch import BlastRadius, PatchIntent
