...
from drift.api.analyzers.typescript.alias_resolver import resolve_tsconfig_alias_import
from drift.api.analyzers.typescript.barrel_resolver import resolve_index_barrel_target
