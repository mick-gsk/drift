...
class TestIntegrationAnalyzeRepo:
    ...
    def test_empty_repo_only_init(self, tmp_path: Path) -> None:
        """Analyze repo with only __init__.py should return 0 drift and no findings."""
        ...
        _git(tmp_path, "add", ".")
        _git(tmp_path, "commit", "-m", "Initial empty repo")
