...
import drift_engine.signals.exception_contract_drift as ecm_mod  # ADR-100 Phase 3: patch real module
import pytest
...
from drift.signals import exception_contract_drift as _ecm_stub
